...
<html>
	<head>
		...
		<link rel = "stylesheet" href="uredjivanjePregled.css">
	</head>
	<body onload="getWeather('London')">
		<header>
			<div class="row no-gutters">
				<div class="col-xl-5">
					<h1 class="pl-5 pt-2">Pregled</h1>
		...
		<div class="centerDiv font">
			<p>Look at the pretty pictures :></p>
			<a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">Also listen to this</a>
		</div>
		<div id="pretty_pictures">
			<!-- <img src="https://via.placeholder.com/600/b4412f" /> -->
		</div>
		<footer class="pt-5">
				<div class="row no-gutters">
					<div class="col-md-3">
					...
					<div class="col-md-3">
						...
						<ul class="footerUl">
							...
							<li class="footerLi">
								<input type="submit" value = "PRIMAJTE OBAVEŠTENJA">
								<?php 
