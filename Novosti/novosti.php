...
<html>
	<head>
		...
		<link rel = "stylesheet" href="uredjivanjeNovosti.css">
	</head>
	<body>
		<header>
			<div class="row no-gutters">
				<div class="col-xl-5">
					<h1 class="pl-5 pt-2">Novosti</h1>
				</div>
				<div class="col-xl-7">
		...
		<h2>Humanitarna akcija</h2>
		<div class="qnaAnswer">U toku je humanitarna akcija koja će u saradnji sa LoveFest organizatorima pomoći u finansiranju lečenja deca koju boluju od autizma, kao i dečije paralize. Sav novac od naplate karata će biti doniran u njihovu korist. Takođe možete da donirate novac preko žiro računa koji će Vam biti prosleđen nakon što unesete Vaš mejl za 'Pratite obaveštenja'</div>
		<h2>Poklon ulaznice</h2>
		<div class="qnaAnswer">U saradnji sa RADIO 96.2, poklanjamo ulaznice nasumično izvučenim učesnicima koji tačno odgovore na pitanja koja će postaviti voditelj Marko u toku dana. Takođe možete uneti mejl na 'Pratite obaveštenja', a mi ćemo nasumičnim odabirom nagraditi petoro prijavljenih učenika.</div>
		<form action="novosti.php" method="POST" enctype="multipart/form-data">
			<footer class="pt-5">
					<div class="row no-gutters">
						<div class="col-md-3">
							
							<p class="footerHeader">Društvene mreze</p>
							<ul class="footerUl">
