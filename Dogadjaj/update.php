	...
	<body>
		<header>
				...
				<div class="col-xl-7">
                    ...
                    <?php
                        ...
                        { 
                            ...
                            {
								$GLOBALS['$test']=$row["id"];
                                // echo "<th>" .$row["id"]. "</th><th>" 
                                // .$row["naziv"]. " </th><th> " 
                                // .$row["email"]. " </th><th> " .$row["br_tel"]. " </th><th> " .$row["mesto_odr"]. " </th><th> " 
                                // .$row["dat_odr"] . "</th><th>" .$row["naziv_dog"]. "</th><th>" .$row["kategorija"]. "</th><th>"
								// .$row["opis"]. "</th>";

								echo '<table class="table table-dark m-auto w-75 fontField"><tr><th>Id</th><th><input class="w-100 formStyle" id="id" type="text" disabled value="'.$row["id"].'"></th></tr>'; 
								echo '<tr><th>Naziv</th><th><input class="w-100 formStyle" id="naziv" type="text" value="'.$row["naziv"].'"></th></tr>';
								echo '<tr><th>Email</th><th><input class="w-100 formStyle" id="email" type="text" value="'.$row["email"].'"></th></tr>';
								echo '<tr><th>Broj telefona</th><th><input class="w-100 formStyle" id="br_tel" type="text" value="'.$row["br_tel"].'"></th></tr>';
								echo '<tr><th>Mesto odrzavanja</th><th><input class="w-100 formStyle" id="mesto_odr" type="text" value="'.$row["mesto_odr"].'"></th></tr>';
								echo '<tr><th>Datum odrzavanja</th><th><input class="w-100 formStyle" id="dat_odr" type="text" value="'.$row["dat_odr"].'"></th></tr>';
								echo '<tr><th>Naziv dogadjaja</th><th><input class="w-100 formStyle" id="naziv_dog" type="text" value="'.$row["naziv_dog"].'"></th></tr>';
								echo '<tr><th>Kategorija</th><th><select class="inputField form-control fontField w-100" id="kategorija"  value="'.$row["kategorija"].'">
															<option value="Naucnik">Naucnik</option>
															<option value="Avanturista">Avanturista</option>
															<option value="Spotista">Sportista</option>
															<option value="Partymaniac">Partymaniac</option>
															<option value="Muzicar">Muzicar</option>
															</select></th></tr>';
								echo '<tr><th>Opis</th><th><input class="w-100 formStyle" id="opis" type="text" value="'.$row["opis"].'"></th></tr></table>';
                            }
                        }
                        else
                        {
            ...
            <form name="myForm" action="update.php" method="post" enctype="multipart/form-data">
                <input type="submit" onclick="promeni()" value="Ažuriraj" class="w-25 changeButtons">
			</form>
				...
				<div class="row no-gutters">
					...
					<div class="col-md-3">
						...
						<ul class="footerUl">
							...
							<li class="footerLi">
								<input type="submit" name="dugmePrimaj" value = "PRIMAJ OBAVEŠTENJA" id="footerButton">
									<?php 
